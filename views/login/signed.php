 		...
 		<div class="panel panel-default">
			...
			<div class="panel-body panel-hover">
				...
				<div class="alert alert-info" role="alert">
				 ...
				 <a role="button" href="/index.php/login/signout" class="btn btn-default sub-btn">LOG OUT</a>
				 <?php else : ?>
				 <div class="alert alert-info" role="alert">
				 ...
				 <a role="button" href="/index.php/login/" class="btn btn-default sub-btn">LOG IN</a> 
				<?php endif;?> 
		  	</div>
 		</div>
